            ...
            200: {
                ...
                content: {
                    ...
                    "application/json": {
                        ...
                        /**
                         * @description Những chỉ số đặc tả có khai mà hệ thống CHƯA đo được,
                         *     kèm lý do.
                         *
                         *     Trả một phần chỉ số rồi im lặng về phần còn lại tạo ra
                         *     đúng thứ hộp đen mà endpoint này sinh ra để tránh —
                         *     chỉ khác là ở phía người viết API. Nói thẳng "chưa đo,
                         *     vì lý do này" trung thực hơn một con số bịa.
                         */
                        not_measured?: {
                            name?: string;
                            reason?: string;
