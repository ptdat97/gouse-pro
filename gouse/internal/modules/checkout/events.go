...
func (p *eventPublisher) PublishCheckoutCompleted(
	...
	e, err := eventbus.NewEvent(
		...
		struct {
			...
			// ShippingFee để sổ cái ghi được khoản phí khách trả.
			// Trường này làm payload lên PHIÊN BẢN 3.
			ShippingFee int64 `json:"shipping_fee"`

			// DiscountAmount để sổ cái ghi được khoản đã giảm cho khách.
			// Trường này làm payload lên PHIÊN BẢN 4.
			DiscountAmount int64 `json:"discount_amount"`

			// CouponCode để promotion ghi nhận lượt dùng. Không có nó
