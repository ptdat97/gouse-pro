...
func TestNguongXetTrenTienHangSauGiamGia(t *testing.T) {
	...
	if err := c.ApplyDiscount("GIAM200", money.MustNew(200_000, money.VND), domain.BenChiuNenTang, nil, testNow); err != nil {
...
func TestThueTinhTrenTienHangSauGiamGia(t *testing.T) {
	...
	if err := c.ApplyDiscount("GIAM50", money.MustNew(50_000, money.VND), domain.BenChiuNenTang, nil, testNow); err != nil {
		t.Fatalf("ApplyDiscount: %v", err)
	}
	if err := c.ApDungPhiVaThue(
